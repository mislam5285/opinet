...
def run_sharing_experiment(init_stances, alphas, betas, gammas, strategies, T, E_mat, calc_utilities=True, keep_actions=True):
    """
    """
...
def run_following_experiment(init_stances, alphas, betas, gammas, strategies, T, E_mat, calc_utilities=True, keep_G=True):
    """
    """
